...
:DOSTUFFASADMIN
 ...
 ECHO Please Wait . . .
 ECHO  - Upgrading DefendPoint to %DPVERSION% EPOMODE if required
 ECHO.
 ...
 msiexec.exe /i "%~dp0PrivilegeManagementForWindows_%PROCARCH%.msi" EPOMODE=1 APPEVENTLOGTYPE=1 REBOOT=R ALLUSERS=1
